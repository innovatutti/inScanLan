...
source.exclude_exts = spec,bat,sh,ico

# (list) List of directory to exclude (let empty to not exclude anything)
source.exclude_dirs = tests, bin, venv, build, dist, .buildozer

# (list) List of exclusions using pattern matching
# Do not prefix with './'
source.exclude_patterns = build_*,*.spec,*.bat
...
requirements = python3,kivy,kivymd,flask,reportlab,Pillow
